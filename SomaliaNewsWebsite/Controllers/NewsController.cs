...
namespace SomaliaNewsWebsite.Controllers
{
    public class NewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,NewsContext,Side,NewsReporter")] News news, HttpPostedFileBase[] uploadImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,NewsContext,Image,Side,NewsReporter")] News news)
        {
            if (ModelState.IsValid)
            {
                news.NewsDate = DateTime.Now;
